...
<head>
    ...
    <title>EstateHUB - Modifier le Type</title>
...
<body>
  ...
  <div class="container">
    <div class="form-container">
      <h2 class="form-title">
        <i class="fa fa-tags"></i> Modifier le type: {{ $type->nom_type }}
      </h2>
      ...
      <form method="POST" action="{{ route('types.update', $type) }}">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="nom_type" name="nom_type" 
                 value="{{ old('nom_type', $type->nom_type) }}" required placeholder="Ex: Appartement, Maison, Villa...">
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" id="description" name="description" 
                    rows="4" placeholder="Description détaillée du type de propriété...">{{ old('description', $type->description) }}</textarea>
        ...
        <div class="form-group">
          ...
          <div class="checkbox-container">
            <label class="checkbox-label">
              ...
              <span class="checkbox-text {{ $type->actif ? 'active' : 'inactive' }}" id="status-text">
  ...
  <script>
    $(document).ready(function() {
      ...
      $('form').on('submit', function(e) {
        ...
        return confirm('Êtes-vous sûr de vouloir modifier ce type ?');
      });
    });
  </script>
