...
<head>
    ...
    <title>EstateHUB - Gestion des Types</title>
...
<body>
  ...
  <div class="page-heading header-text">
    <div class="container">
      ...
      <h3>Gestion des Types de Propriétés</h3>
    </div>
  </div>
                    ...
                    <tr>
                      <td colspan="6" class="text-center">
                        <div class="py-4">
                          ...
                          <p class="text-muted">Aucun type de propriété trouvé.</p>
                          <a href="{{ route('types.create') }}" class="btn btn-primary mt-2">
                            <i class="fa fa-plus"></i> Créer votre premier type
                          </a>
                        </div>
                      </td>
                    </tr>
                ...
                <div class="col-md-4">
                  <div class="card text-white bg-primary mb-3">
                    <div class="card-body text-center">
                      ...
                      <h2 class="card-text">{{ $types->total() }}</h2>
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="card text-white bg-success mb-3">
                    <div class="card-body text-center">
                      <h5 class="card-title">Types Actifs</h5>
                      <h2 class="card-text">{{ $types->where('actif', true)->count() }}</h2>
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="card text-white bg-warning mb-3">
                    <div class="card-body text-center">
                      <h5 class="card-title">Types Inactifs</h5>
                      <h2 class="card-text">{{ $types->where('actif', false)->count() }}</h2>
                    </div>
                  </div>
                </div>
              </div>
  ...
  <script>
    $(document).ready(function() {
      ...
      $('.btn-danger').on('click', function(e) {
        if (!confirm('Êtes-vous sûr de vouloir supprimer ce type ? Cette action est irréversible.')) {
          e.preventDefault();
          return false;
        }
      });
